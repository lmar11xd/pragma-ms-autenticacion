...
class ApplicantTest {
    ...
    void testNoArgsConstructorAndSetters() {
        ...
        applicant.setEmail(new Email("test@example.com"));
        ...
        assertThat(applicant.getEmail().getValue()).isEqualTo("test@example.com");
    ...
    void testAllArgsConstructor() {
        ...
        assertThat(applicant.getEmail().getValue()).isEqualTo("carlos@example.com");
    ...
    void testBuilderAndToBuilder() {
        ...
        assertThat(applicant.getEmail().getValue()).isEqualTo("ana@example.com");
